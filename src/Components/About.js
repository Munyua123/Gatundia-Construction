  ...
  return (
    <div>
      ...
      <div className="about">
        ...
        <p>
          From road-building materials to Kenha Markers for clear and safe
          traffic guidance, we have you covered. Our expertise extends to
          crafting durable fencing posts made of concrete, offering a
          long-lasting solution for your property needs.
        </p>
        <p>
        ...
        <p>
          At Gatundia Concrete Limited, we are more than just a supplier - we
          are your trusted partner in building a better future. Contact us today
          to discover how we can contribute to the success of your next
